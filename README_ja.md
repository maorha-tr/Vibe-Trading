...
| **eToro** | global multi-asset | read + demo (virtual portfolio) orders via the public API; real accounts read-only — demo routes carry a `demo` path segment and user keys are environment-bound |
