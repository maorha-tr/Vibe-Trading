...
class DataConfig(_EnvBase):
    ...
    etoro_sso_client_id: str = Field(alias="ETORO_SSO_CLIENT_ID", default="")
    etoro_sso_client_secret: str = Field(alias="ETORO_SSO_CLIENT_SECRET", default="")
    etoro_sso_redirect_uri: str = Field(alias="ETORO_SSO_REDIRECT_URI", default="")
    etoro_sso_scopes: str = Field(alias="ETORO_SSO_SCOPES", default="")
