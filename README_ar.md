...
| **eToro** | متعدد الأصول عالمياً | قراءة + أوامر تجريبية (محفظة افتراضية) عبر الـ API العام؛ الحسابات الحقيقية للقراءة فقط — مسارات demo تحمل مقطع `demo` في المسار ومفاتيح المستخدم مرتبطة بالبيئة |
